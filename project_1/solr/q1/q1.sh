...
python3 ../M3/mix_querys.py --query "fever vomit" --semantic 1.0 --lexical 0.0 > resultados_simple.json
...
python3 ../M3/mix_querys.py --query "fever vomit" --semantic 0.5 --lexical 0.5 > resultados_simple.json
...
python3 ../M3/mix_querys.py --query "fever vomit" --semantic 0.7 --lexical 0.3 > resultados_simple.json
...
python3 ../M3/mix_querys.py --query "fever vomit" --semantic 0.3 --lexical 0.7 > resultados_simple.json
...
python3 ../M3/mix_querys.py --query "fever vomit" --semantic 0.0 --lexical 1.0 > resultados_simple.json
...
python3 ../relevance_feedback.py --query "fever vomit" --alpha 1.0 --beta 0.75 --gamma 0.15
...
python3 ../relevance_feedback.py --query "fever vomit" --alpha 1.0 --beta 0.5 --gamma 0.1
...
python3 ../relevance_feedback.py --query "fever vomit" --alpha 1.0 --beta 1.0 --gamma 0.0
...
python3 ../relevance_feedback.py --query "fever vomit" --alpha 1.0 --beta 16.0 --gamma 4.0
