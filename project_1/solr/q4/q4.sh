...
python3 ../relevance_feedback.py --query "persistent fatigue exhaustion" --alpha 1.0 --beta 0.75 --gamma 0.15
...
python3 ../relevance_feedback.py --query "persistent fatigue exhaustion" --alpha 1.0 --beta 0.5 --gamma 0.1
...
python3 ../relevance_feedback.py --query "persistent fatigue exhaustion" --alpha 1.0 --beta 1.0 --gamma 0.0
...
python3 ../relevance_feedback.py --query "persistent fatigue exhaustion" --alpha 1.0 --beta 16.0 --gamma 4.0
