...
python3 ../M3/mix_querys.py --query "cardiovascular heart surgery" --semantic 1.0 --lexical 0.0 > resultados_simple.json
...
python3 ../M3/mix_querys.py --query "cardiovascular heart surgery" --semantic 0.5 --lexical 0.5 > resultados_simple.json
...
python3 ../M3/mix_querys.py --query "cardiovascular heart surgery" --semantic 0.7 --lexical 0.3 > resultados_simple.json
...
python3 ../M3/mix_querys.py --query "cardiovascular heart surgery" --semantic 0.3 --lexical 0.7 > resultados_simple.json
...
python3 ../M3/mix_querys.py --query "cardiovascular heart surgery" --semantic 0.0 --lexical 1.0 > resultados_simple.json
